...
[KernelFunction]
    ...
    /// </summary>
[KernelFunction]
    [Description("Get all bookings for a single hotel with a minumum start date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
        [Description("The ID of the hotel")]int hotelId, 
        [Description("The minimum start date for hotel booking.")]DateTime dt)
    {
...
[KernelFunction]
    [Description("Get all bookings for a missing hotel room")]
...
[KernelFunction]
    [Description("Get all bookings for mutiple hotel rooms")]
